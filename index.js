...
const queueUrl = 'https://sqs.us-east-1.amazonaws.com/533267034838/fila-desafio-aws.fifo';
app.post('/transaction', async (req, res) => {
    ...
    try {
        ...
        res.json({ message: 'Transação enviada para a fila com sucesso!', messageId: data.MessageId });
    } catch (error) {
